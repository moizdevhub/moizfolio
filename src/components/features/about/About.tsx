...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="bg-[#000000fa] bg-[url('/square.png')] bg-cover bg-center relative min-h-screen backdrop-blur-md  text-white flex items-center justify-center overflow-hidden">
